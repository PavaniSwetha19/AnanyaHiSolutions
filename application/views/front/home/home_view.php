...
<section class="bg-light py-5">
    ...
    <h2 class="fw-bold">
     Comprehensive Digital Transformation Services in Hyderabad
    </h2>
   
  </div>
  
    <p>Welcome to <a href="https://www.anyahisolutions.com" class="text-decoration-none">Ananya Hi Solutions</a>, your trusted partner for comprehensive digital transformation in Hyderabad. With over a decade of experience, we specialize in creating powerful digital experiences that drive measurable business growth.</p>
    ...
    <p>Based in Hyderabad, we proudly serve clients across India and globally, bringing local expertise with international standards. Our portfolio spans multiple industries including e-commerce, healthcare, education, finance, and technology sectors.
</p>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        How does Ananya Hi Solutions ensure quality in digital marketing campaigns?
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        What makes Ananya Hi Solutions different from other digital agencies in Hyderabad?

      </button>
    </h2>
    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div class="accordion-body">
       Our key differentiators include 10+ years of proven experience, a team of certified experts, integrated service offerings under one roof, customized solutions rather than templates, transparent pricing, dedicated account management, and a proven track record of delivering measurable ROI for clients across diverse industries.
   ...
   <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
       What industries does Ananya Hi Solutions specialize in serving?
