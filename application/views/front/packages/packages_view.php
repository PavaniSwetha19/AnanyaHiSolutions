    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="package-card h-100 shadow-sm position-relative">
          ...
          <div class="package-body p-4">
            <ul class="list-unstyled mb-4 feature-list">
              <li><i class="bi bi-check-circle-fill text-success me-2"></i>Delivery Within 3 Working Days.</li>
...
<section class="packages-section py-5">
  <div class="container">
    <div class="text-center mb-5">
      <h2 class="fw-bold display-6">Special Packages</h2>
      <p class="text-muted lead">Exclusive Packages Crafted Just for You ✨.</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="package-card h-100 shadow-sm position-relative">
          <div class="package-header text-white text-center py-4 rounded-top" style="background-color:#1485cb">
            <h5 class="mb-1">Spa Packages</h5>
            <p class="mb-0">Perfect for Small Businesses</p>
          </div>
          <div class="package-body p-4">
            <ul class="list-unstyled mb-4 feature-list">
              <li><i class="bi bi-check-circle-fill text-success me-2"></i>Performance Insights Report.</li>
              <li><i class="bi bi-check-circle-fill text-success me-2"></i>Social Media Setup (Instagram & Facebook).</li>
              <li><i class="bi bi-check-circle-fill text-success me-2"></i>Social Media Management.</li>
              <li><i class="bi bi-check-circle-fill text-success me-2"></i>Content Strategy & Planning.</li>
              <li class="blurred"><i class="bi bi-check-circle-fill text-success me-2"></i>Basic SEO Setup.</li>
              <li class="blurred"><i class="bi bi-check-circle-fill text-success me-2"></i>Browser Compatibility Testing.</li>
              <li class="blurred"><i class="bi bi-check-circle-fill text-success me-2"></i>Google Page Speed Optimized.</li>
            </ul>
           <div class="my-2">
              <h6 class="fw-bold text-dark">Want to know what’s inside our hidden plans?</h6>
              <a href="<?= base_url('package-details/spa-marketing-package-hyderabad') ?>" class="btn btn-gradient">
                <i class="bi bi-unlock-fill me-2"></i>Unlock Full Packages
              </a>
            </div>
          </div>
