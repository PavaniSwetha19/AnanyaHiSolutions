...
class ServicesController extends CI_Controller {
	...
	public function website_design()
    {
        ...
        //SEO
		$header_data['meta_title'] = "Website Design & Development Company Hyderabad | Ananya Hi Solutions";
		$header_data['meta_description'] = "Professional website design and development services in Hyderabad. Responsive, SEO-optimized, conversion-focused websites. Custom CMS solutions. Free consultation available.";
...
$data['full_details'] = "<section class='bg-light py-5'>
    <div class='container'>
        <h2>Professional Website Design and Development Services in Hyderabad</h2>

        <p>In today's digital-first world, your <a href='https://www.ananyahisolutions.com'>website</a> is often the first impression potential customers have of your business. At Ananya Hi Solutions, we create stunning, high-performance websites that not only look exceptional but drive real business results.</p>

        <p>Our website design and development services combine aesthetic excellence with technical sophistication. Every website we build is fully responsive (mobile, tablet, desktop), optimized for search engines, designed for fast loading speeds, and focused on user experience and conversion optimization.</p>
...
<div class='accordion-body'>
Our comprehensive packages include custom responsive design, content management system, SEO-friendly structure, contact forms, Google Analytics integration, social media integration, SSL certificate setup, up to 10-15 pages, image optimization, cross-browser compatibility testing, 3 months technical support, and basic SEO setup. Advanced features are available in premium packages.
</div>
</div>
</div>
...
What ongoing support do you provide after website launch?
</button>
</h2>
...
We provide comprehensive post-launch support including 3 months free technical support, security updates and patches, performance monitoring, content updates (in select packages), backup management, bug fixes, hosting assistance, and analytics reporting. Extended maintenance packages are available for ongoing support and enhancements.
	...
	public function digital_marketing()
	{
	    ...
	    //SEO
		$header_data['meta_title'] = "Best Digital Marketing Agency Hyderabad | SEO, PPC, Social Media Services";
		$header_data['meta_description'] = "Top digital marketing agency in Hyderabad offering SEO, PPC, social media marketing, content marketing & lead generation. Proven ROI. Certified experts. Get free audit.";
		$header_data['canonical_url'] = current_url();
    ...
    <div class='container'>
        ...
        <h2 class='mt-5'>Results-Driven Digital Marketing Services in Hyderabad</h2>

        <p>In the competitive digital landscape, strategic marketing is essential for business growth.<a href='https://www.ananyahisolutions.com'> Ananya Hi Solutions</a> is Hyderabad's premier digital marketing agency, delivering data-driven campaigns that generate qualified leads, increase brand visibility, and maximize return on investment.</p>

        <p>Our comprehensive digital marketing services encompass Search Engine Optimization (SEO) for organic rankings, Pay-Per-Click (PPC) advertising for immediate results, Social Media Marketing across all major platforms, Content Marketing that engages and converts, Email Marketing for nurturing leads, Conversion Rate Optimization, and comprehensive Analytics and Reporting.</p>

        <p>What distinguishes our approach is our commitment to understanding your business goals, target audience, and competitive landscape before crafting customized strategies. We don't believe in one-size-fits-all solutions. Every campaign is meticulously planned, executed with precision, and continuously optimized based on real-time data and performance metrics.</p>

        <p>Our certified digital marketing team stays ahead of algorithm updates, platform changes, and industry trends to ensure your campaigns remain effective. We've helped businesses across industries achieve 200-400% increases in organic traffic, 3-5X ROI on ad spend, and substantial growth in qualified leads and conversions.</p>
...
<h2 class='accordion-header'>
<button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#collapseOne' aria-expanded='true' aria-controls='collapseOne'>
What digital marketing services does Ananya Hi Solutions offer?
</button>
</h2>
<div id='collapseOne' class='accordion-collapse collapse show' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseFive' aria-expanded='false'>
What makes Ananya Hi Solutions effective at social media marketing?
</button>
</h2>
<div id='collapseFive' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Our social media success stems from strategic audience research, platform-specific content creation, consistent posting schedules, community engagement, influencer partnerships, paid social advertising, A/B testing, and data-driven optimization. We create authentic brand voices that resonate with target audiences, driving engagement, followers, and conversions across all major platforms.
    ...
    public function mobile_app()
    {
        ...
        //SEO
        $header_data['meta_title'] = "Mobile App Development Company Hyderabad | iOS & Android Apps";
        $header_data['meta_description'] = "Professional mobile app development services in Hyderabad. Native iOS, Android & hybrid apps. Custom solutions for startups to enterprise. Free consultation.";
        $header_data['canonical_url'] = current_url();
...
$data['full_details'] = "<section class='bg-light py-5'>
    <div class='container'>
        ...
        <h2 class='mt-5'>Custom Mobile App Development Services in Hyderabad</h2>

        <p><a href='https://www.ananyahisolutions.com'>Mobile applications</a> have become essential business tools, providing direct customer engagement, enhanced brand loyalty, and new revenue streams. Ananya Hi Solutions delivers innovative, user-centric mobile applications that transform how businesses connect with their customers.</p>

        <p>Our mobile app development expertise spans native iOS development (Swift, Objective-C), native Android development (Kotlin, Java), hybrid app development (React Native, Flutter), and progressive web apps (PWA). We build apps across categories including e-commerce, on-demand services, social networking, enterprise solutions, gaming, education, and healthcare.</p>

        <p>Every mobile application we develop follows user-centered design principles, ensuring intuitive navigation, engaging interfaces, and seamless user experiences. Our development process includes comprehensive market research, detailed wireframing and prototyping, agile development methodology, rigorous quality assurance, app store optimization, and post-launch support and updates.</p>

        <p>Security, performance, and scalability are fundamental to our approach. We implement robust security protocols, optimize for fast loading and minimal battery consumption, ensure compatibility across devices and OS versions, and build scalable architectures that grow with your user base.</p>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseTwo' aria-expanded='false' aria-controls='collapseTwo'>
How much does mobile app development cost at Ananya Hi Solutions?
</button>
</h2>
<div id='collapseTwo' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Mobile app costs vary significantly based on complexity, features, platform, and design requirements. Simple apps start from ₹1,50,000, medium complexity apps range ₹3,00,000-₹8,00,000, and complex enterprise apps can exceed ₹10,00,000. We provide detailed cost breakdowns after analyzing requirements, considering design, development, testing, deployment, and maintenance.
</div>
</div>
</div>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseThree' aria-expanded='false' aria-controls='collapseThree'>
What is the typical timeline for developing a mobile application?
</button>
</h2>
<div id='collapseThree' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Development timelines depend on app complexity and features. Simple apps take 2-3 months, medium complexity apps require 4-6 months, and complex enterprise applications need 6-12+ months. The process includes planning (2-3 weeks), design (3-4 weeks), development (60-70% of timeline), testing (3-4 weeks), and deployment (1-2 weeks). We provide detailed project schedules with milestones.
</div>
</div>
</div>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseFive' aria-expanded='false'>
What post-launch support do you provide for mobile applications?
</button>
</h2>
<div id='collapseFive' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Our post-launch support includes bug fixes and technical support (3-6 months free), performance monitoring and optimization, OS compatibility updates, feature enhancements, app store management, user analytics and reporting, server maintenance, and ongoing consultation. Extended Annual Maintenance Contracts (AMC) are available for continuous support, updates, and improvements.
</div>
</div>
</div>
    ...
    //SEO
            $header_data['meta_title'] = "E-commerce Development Company Hyderabad | Online Store Solutions";
            $header_data['meta_description'] = "Custom e-commerce development in Hyderabad. Shopify, WooCommerce, Magento experts. Secure payment integration. Inventory management. Scale your online business.";
            $header_data['canonical_url'] = current_url();
...
<div id='collapseTwo' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Mobile app costs vary significantly based on complexity, features, platform, and design requirements. Simple apps start from ₹1,50,000, medium complexity apps range ₹3,00,000-₹8,00,000, and complex enterprise apps can exceed ₹10,00,000. We provide detailed cost breakdowns after analyzing requirements.
</div>
</div>
</div>
...
<div id='collapseThree' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Simple apps take 2–3 months, medium apps 4–6 months, and complex <a href='https://www.ananyahisolutions.com'>enterprise applications</a> 6–12+ months. Timeline includes planning, design, development, testing, and deployment with clear milestones.
</div>
</div>
</div>
...
<div id='collapseFour' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We use SSL/TLS encryption, OAuth/JWT authentication, secure APIs, encrypted storage, GDPR compliance, security audits, and protection against SQL injection and XSS vulnerabilities.
</div>
</div>
</div>
...
<div id='collapseFive' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Bug fixes, performance monitoring, OS updates, feature enhancements, analytics, server maintenance, and AMC support packages are available.
</div>
</div>
</div>
...
What e-commerce platforms does Ananya Hi Solutions work with?
</button>
</h2>
<div id='collapseSix' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We work with Shopify, Shopify Plus, WooCommerce, Magento, PrestaShop, OpenCart, and custom PHP/Laravel frameworks. Platform selection depends on business size, budget, scalability, and feature requirements.
</div>
</div>
</div>
...
How do you ensure e-commerce website security and PCI compliance?
</button>
</h2>
<div id='collapseSeven' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We implement SSL encryption, PCI DSS compliance, secure gateways, vulnerability scanning, fraud detection, admin access controls, regular backups, and protection against SQL injection and XSS attacks.
</div>
</div>
</div>
...
What payment gateways can be integrated into e-commerce websites?
</button>
</h2>
<div id='collapseEight' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We integrate Razorpay, PayU, CCAvenue, Instamojo, Paytm, Stripe, PayPal, Square, Authorize.net, UPI, wallets, COD, and bank transfers to maximize conversions.
</div>
</div>
</div>
...
How do you optimize e-commerce websites for conversions?
</button>
</h2>
<div id='collapseNine' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We optimize checkout flow, product media, SEO descriptions, reviews, recommendations, urgency triggers, trust badges, mobile UX, and A/B testing to increase sales.
</div>
</div>
</div>
...
What ongoing support is provided for e-commerce platforms?
</button>
</h2>
<div id='collapseTen' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Support includes updates, security patches, payment maintenance, inventory help, backups, performance tuning, feature additions, campaign support, and analytics reporting with custom maintenance plans.
</div>
</div>
</div>
    ...
    //SEO
            $header_data['meta_title'] = "Professional Video Production Services Hyderabad | Corporate Videos";
            $header_data['meta_description'] = "Expert video production in Hyderabad. Corporate videos, product demos, social media content, explainer videos. Professional filming, editing & animation.";
            $header_data['canonical_url'] = current_url();
...
$data['full_details'] = "<section class='bg-light py-5'>
    <div class='container'>
        ...
        <h2 class='mt-5'>Professional Video Production Services in Hyderabad</h2>

        <p><a href='https://www.ananyahisolutions.com'>Video content</a> has emerged as the most engaging and effective medium for digital communication. Ananya Hi Solutions offers professional video production services that capture attention, communicate messages effectively, and drive audience engagement across all digital platforms.</p>

        <p>Our comprehensive video production services include corporate videos showcasing company culture and values, product demonstration videos highlighting features and benefits, explainer videos simplifying complex concepts, social media video content optimized for each platform, testimonial videos building credibility, training and educational videos, event coverage, and animated videos for abstract concepts.</p>

        <p>We manage the entire video production process from concept development and scriptwriting, professional filming with high-quality equipment and lighting, expert editing and post-production, motion graphics and animation, voice-over recording in multiple languages, background music and sound design, color grading for a professional look, to final delivery in multiple formats optimized for YouTube, Instagram, LinkedIn, and websites.</p>

        <p>Our experienced production team combines creative storytelling with technical excellence, ensuring every video aligns with your brand identity, resonates with target audiences, and achieves marketing objectives. Whether you need a 30-second social media clip or a comprehensive corporate documentary, we deliver exceptional results.</p>
...
<h2 class='accordion-header'>
<button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#collapseOne' aria-expanded='true' aria-controls='collapseOne'>
What types of video production services does Ananya Hi Solutions offer?
</button>
</h2>
<div id='collapseOne' class='accordion-collapse collapse show' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseThree' aria-expanded='false' aria-controls='collapseThree'>
What is the typical timeline for video production projects?
</button>
</h2>
<div id='collapseThree' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseFour' aria-expanded='false'>
How do you ensure video content aligns with brand identity?
</button>
</h2>
<div id='collapseFour' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We conduct thorough brand discovery sessions covering brand guidelines, colors, fonts, tone, and messaging. Our creative team develops concepts and storyboards for approval before filming, ensures consistent visual style, incorporates brand elements (logos, colors, music), and provides multiple revision rounds to perfectly align with brand identity and marketing objectives.
</div>
</div>
</div>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseFive' aria-expanded='false'>
What video formats and platforms do you optimize content for?
</button>
</h2>
<div id='collapseFive' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We deliver videos optimized for all major platforms including YouTube (HD, 4K), Instagram (Feed, Stories, Reels, IGTV), Facebook, LinkedIn, Twitter, TikTok, website embedding, presentations, and broadcast. Each platform requires specific aspect ratios (16:9, 9:16, 1:1), durations, and technical standards which we optimize for maximum engagement.
    ...
    //SEO
            $header_data['meta_title'] = "Custom Software Development Company Hyderabad | Enterprise Solutions";
            $header_data['meta_description'] = "Custom software development services in Hyderabad. CRM, ERP, SaaS solutions. Scalable, secure, user-friendly applications. Expert developers. Free consultation. ";
            $header_data['canonical_url'] = current_url();
    ...
    <div class='container'>
        ...
        <h2 class='mt-5'>Custom Software Development Services in Hyderabad</h2>

        <p><a href='https://www.ananyahisolutions.com'>Custom software development</a> empowers businesses to address unique operational challenges, improve efficiency, and gain competitive advantages. Ananya Hi Solutions delivers tailored software solutions that streamline processes, enhance productivity, and drive digital transformation.</p>

        <p>Our software development expertise encompasses enterprise resource planning (ERP) systems integrating all business functions, customer relationship management (CRM) platforms optimizing sales and customer service, inventory and supply chain management solutions, human resource management systems (HRMS), accounting and financial management software, project management applications, and custom business automation tools.</p>

        <p>We leverage modern technologies and frameworks including Python (Django, Flask) for rapid development, PHP (Laravel, CodeIgniter) for web applications, Java for enterprise solutions, .NET for Windows-based systems, Node.js for real-time applications, and cloud technologies (AWS, Azure, Google Cloud) for scalable deployments. Our solutions are platform-agnostic and integrate seamlessly with existing systems.</p>

        <p>Our development methodology follows agile principles with regular sprints, continuous stakeholder involvement, iterative development and feedback cycles, comprehensive testing at every stage, detailed documentation, and seamless deployment. We ensure solutions are scalable to accommodate business growth, secure with industry-standard protocols, maintainable with clean code practices, and user-friendly with intuitive interfaces.</p>
...
<h2 class='accordion-header'>
<button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#collapseOne' aria-expanded='true' aria-controls='collapseOne'>
What types of custom software does Ananya Hi Solutions develop?
</button>
</h2>
<div id='collapseOne' class='accordion-collapse collapse show' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
We develop comprehensive software solutions including ERP systems for integrated business management, CRM platforms for customer relationship optimization, inventory and supply chain management systems, HRMS for employee management, accounting and billing software, project management tools, workflow automation applications, API development and integrations, and SaaS (Software as a Service) platforms. All solutions are customized to specific business requirements.
</div>
</div>
</div>
...
<div id='collapseThree' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
Costs vary significantly based on complexity, features, integrations, and user scale. Simple automation tools start from ₹2,00,000, medium complexity applications range ₹5,00,000–₹15,00,000, and enterprise-level systems can exceed ₹25,00,000. Timelines range from 3 months for simple applications to 12+ months for complex enterprise systems. We provide detailed project estimates after requirements analysis.
</div>
</div>
</div>
...
<h2 class='accordion-header'>
<button class='accordion-button collapsed' type='button' data-bs-toggle='collapse' data-bs-target='#collapseFive' aria-expanded='false'>
What ongoing maintenance and support do you provide for custom software?
</button>
</h2>
<div id='collapseFive' class='accordion-collapse collapse' data-bs-parent='#accordionExample'>
<div class='accordion-body'>
