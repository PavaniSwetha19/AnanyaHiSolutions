...
class HomeController extends CI_Controller {
	...
	{
		//SEO
		$header_data['meta_title'] = "Ananya Hi Solutions - Premier Digital Marketing & Web Design Company in Hyderabad";
		$header_data['meta_description'] = "Transform your digital presence with Ananya Hi Solutions. Expert web design, digital marketing, mobile apps & software development in Hyderabad. 10+ years experience delivering results.";
