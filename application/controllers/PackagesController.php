...
class PackagesController extends CI_Controller {
	...
	public function package_details()
	{
        ...
        switch ($slug) {
            ...
            case 'spa-marketing-package-hyderabad':
                $package_name = "Spa Marketing Package";
                break;
	...
	public function thank_you(){
       ...
       // Define ALL PACKAGES with subplans
        $all_packages = [
            ...
            'spa-marketing-package-hyderabad' => [
                'Basic' => [
                    // 'price' => '₹3,999',
                    'price' => '₹9,999 + GST/Month',
                    'features' => [
