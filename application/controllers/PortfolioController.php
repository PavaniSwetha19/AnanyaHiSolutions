...
class PortfolioController extends CI_Controller {
	...
	{
		//SEO
	$header_data['meta_title'] = "Portfolio – Google Ads, Meta Ads & Web Projects | Ananya Hi Solutions";
		$header_data['meta_description'] = "Explore our proven portfolio of Google Ads, Meta Ads, and high-conversion websites. See how Ananya Hi Solutions delivers quality leads and strong ROI for businesses.";
		...
		$this->load->view('front/portfolio/portfolio_view');
