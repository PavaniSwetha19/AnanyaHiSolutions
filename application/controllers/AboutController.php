...
class AboutController extends CI_Controller {
	...
	{
		//SEO
		$header_data['meta_title'] = "About Ananya Hi Solutions - Expert Digital Marketing Team in Hyderabad";
		$header_data['meta_description'] = "Learn about Ananya Hi Solutions' 10+ year journey in digital excellence. Meet our certified experts delivering innovative web design, marketing & development solutions in Hyderabad.";
